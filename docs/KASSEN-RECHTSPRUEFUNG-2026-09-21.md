...
- Originalbons bleiben unverändert. Gegenbelege erhalten eigene Nummer, Originalbezug, Grund, optionale Erläuterung, Bedienung, Erstattungsart und Buchungsdatum. Bereits erstattete Mengen sind gesperrt. Wiederholung nach unklarer Serverantwort verwendet dieselbe Vorgangs-ID. PDF-Archivierung ist unabhängig von der bereits gebuchten Korrektur wiederholbar.
...
## Ergänzung: vereinfachter Storno

Migration 024 entfernt die Pflicht zur freien Erläuterung. Der ausgewählte Stornogrund bleibt dokumentiert. Die Datenbank bucht positive Warenpositionen automatisch zurück in den Bestand, außer bei den Gründen „Beschädigung / Bruch“ und „Abgelaufene oder mangelhafte Ware“ (Erweiterung durch Migration 025). Der manuelle Verkaufsfähig-Haken entfällt; auch abweichende Werte älterer Clients beeinflussen die Lagerentscheidung nicht. Bruch, abgelaufene und mangelhafte Ware werden im Gegenbeleg dokumentiert, ohne den bereits beim Verkauf reduzierten Bestand erneut zu verändern. Vorhandene Original- und Gegenbelege bleiben unverändert.

Geprüft: optionale/fehlende Erläuterung, sämtliche Stornogründe, überholte Client-Haken, Bestand und Lagerbewegungen, Wiederholung ohne Doppelbuchung, unveränderte Finanz-/Berechtigungsregeln sowie Browserablauf auf iPad-Abmessungen. Die native Kasse lädt dieselbe veröffentlichte Oberfläche; kein neuer App-Build erforderlich.
