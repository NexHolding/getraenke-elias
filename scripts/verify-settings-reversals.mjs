...
try{
 ...
 for(const [index,reason] of ['Kunde hat nicht bezahlt','Beschädigung / Bruch'].entries()) {
 ...
 await page.getByText(index===0?'Automatisch zurück ins Lager':'Bruch · keine Bestandsrückbuchung',{exact:true}).waitFor();
